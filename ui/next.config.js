...
const nextConfig = {
   ...
   */
  basePath: isProd ? '/Mina-HTLCNative': '', // update if your repo name changes for npm run deploy to work successfully
  assetPrefix: isProd ? '/Mina-HTLCNative': '', // update if your repo name changes for npm run deploy to work successfully
